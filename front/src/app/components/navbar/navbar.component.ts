...
export class NavbarComponent implements OnInit {
  ...
  toggleThemeMode(): void {
    const themeToggleBtn: HTMLElement | null = document.getElementById("dropdownDefaultButton");
    const dropdownMenu: HTMLElement | null = document.getElementById("dropdown");
    const lightModeBtn: HTMLElement | null = document.getElementById("light-mode");
    const darkModeBtn: HTMLElement | null = document.getElementById("dark-mode");
    const systemModeBtn: HTMLElement | null = document.getElementById("system-mode");
